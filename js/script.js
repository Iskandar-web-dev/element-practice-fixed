...
const reload = (data) => {
  ...
  for (let item of data) {
    ...
    span.innerHTML = item.description.slice(0, 120);
    button.innerHTML = "В избранное";
    dollarP.innerHTML = item.price;
    starP.innerHTML = item.rating.rate;
    packageP.innerHTML = item.rating.count;
    ...
    // append // c
    center.append(productImg);
    topi.append(center);
    bottom.append(h2);
    bottom.append(span);
    bottom.append(price);
    bottom.append(button);
    productCard.append(topi);
    productCard.append(bottom);
    main.append(productCard);
    dollarContainer.append(dollarIcon);
    dollarContainer.append(dollarP);
    price.append(dollarContainer);
    starContainer.append(starIcon);
    starContainer.append(starP);
    price.append(starContainer);
    packageContainer.append(packageIcon);
    packageContainer.append(packageP);

    price.append(packageContainer);
    ...
    button.onclick = () => {
      ...
      first_h1.innerHTML = `В корзине: ${myCart.length} товар`;
    };
  }
};
